    ...
    return (
        <section id="servicos" className="relative w-full overflow-hidden bg-brand-surface py-section-y md:py-section-y-lg">
            ...
            <div className="absolute inset-0 z-0 bg-brand-surface">
                {/* Optional radial gradient for subtle highlight */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[600px] bg-brand-orange/5 blur-[120px] rounded-full pointer-events-none" />
            </div>
            ...
            <div className="relative z-10 mx-auto w-full max-w-container px-container-px md:px-container-px-md lg:px-container-px-lg">
                <div className="mb-16 flex flex-col items-center text-center">
                    ...
                    <h2 className="mt-2 mb-6 font-barlow-condensed text-display-lg font-bold uppercase leading-none text-brand-offwhite">
                        {SERVICES_COPY.headline[0]} <br className="hidden md:block" />
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 md:gap-8">
                    {SERVICES_COPY.services.map((service, index) => (
                        <ServiceCard
                            ...
                            className="bg-brand-black/40 backdrop-blur-sm z-10"
                        />
                    ))}
                </div>
