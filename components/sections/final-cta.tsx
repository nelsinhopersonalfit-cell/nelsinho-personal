        ...
        <section id="contato" className="relative w-full overflow-hidden bg-brand-surface py-10 md:py-16">
            ...
            <div className="relative z-10 mx-auto w-full max-w-container px-container-px md:px-container-px-md lg:px-container-px-lg">
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <h2 className="mb-4 font-barlow-condensed text-balance text-display-xl font-bold uppercase leading-none text-brand-offwhite drop-shadow-lg">
                        {CTA_COPY.headline[0]}{" "}
                        <span className="text-brand-orange">{CTA_COPY.headline[1]}</span>
                    </h2>

                    <p className="mb-6 max-w-2xl font-inter text-body-lg text-brand-offwhite/90 drop-shadow-md">
