    ...
    transformations: [
        {
            ...
            beforeAlt: "Foto antes da transformação de [nome]",
            afterAlt: "Foto depois da transformação de [nome]",
        },
        // Mock duplicados para UI Inicial
        {
            name: "[PREENCHER 2]",
            result: "[PREENCHER 2]",
            description: "[PREENCHER depoimento 2]",
            beforeAlt: "Antes",
            afterAlt: "Depois",
        },
    ],
