...
export const TESTIMONIALS_COPY = {
    ...
    testimonials: [
        ...
        },
        {
            ...
            result: "-18kg em 6 meses",
            stars: 5,
            text: "Perder 18kg em 6 meses parecia impossível, mas com o acompanhamento do Nelsinho eu consegui! A metodologia e o incentivo dele fizeram toda a diferença na minha jornada.",
            avatarAlt: "Foto de Adriana, aluna do Nelsinho Personal",
            avatarImage: "/images/testimonials/avatar-female.png",
        },
    ],
};
