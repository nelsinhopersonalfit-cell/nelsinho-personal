    ...
    testimonials: [
        {
            ...
            result: "-9kg em 30 dias",
            stars: 5,
            text: "Em apenas 30 dias consegui resultados que nunca imaginei! O Nelsinho é um profissional incrível e me motivou todos os dias com um treino focado no meu objetivo. Estou muito feliz!",
            avatarAlt: "Foto de Thaise, aluna do Nelsinho Personal",
            avatarImage: "/images/testimonials/t2-after-compressed.webp",
        },
        {
            name: "Thaiz",
            result: "-10kg (74kg → 64kg)",
            stars: 5,
            text: "O Nelsinho mudou minha vida! Com o apoio dele, eliminei 10kg e conquistei a saúde que sempre quis. Me sinto extremamente bem!",
            avatarAlt: "Foto de Thaiz, aluna do Nelsinho Personal",
            avatarImage: "/images/testimonials/t3-after-compressed.webp",
        },
    ],
};
